...
protocol BreakdownRandevuCellDelegate: AnyObject {
    func didTapEdit()
}

class BreakdownRandevuCell: UICollectionViewCell, Reusable {
    ...
    weak var delegate: BreakdownRandevuCellDelegate?
